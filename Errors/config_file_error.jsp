...
<html>
    ...
    <body>
        ...
        <div id="page-container">
            ...
            <div id="content">
                <div class="padding"> 
                    The configuration file '.WImpiBLAST.conf' is not found. Kindly consult installation manual to learn how
                    to setup configuration file for using WImpiBLAST.'
                    <br><br>
                    You can ask your administrator to setup the configuration file for use.
                    <br><br>
